...
object VolleyWrapper {
     ...
     *
     * @param context [Context] used to create the request queue.
     */
     ...
     * to send to the server.
     *
     * @param requestQueue [RequestQueue] that will be used for queueing the requests to send to the server.
     */
     ...
     * @param responseCallback [ResponseCallback] that will receive the response from this request.
     */
